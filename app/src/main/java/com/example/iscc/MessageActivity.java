...
import com.example.iscc.notification.Client;
import com.example.iscc.notification.Data;
...
import com.example.iscc.ui.adapter.MessageAdapter;
import com.example.iscc.ui.chat.APIService;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    Token user = dataSnapshot.getValue(Token.class);
                    Data data = new Data(firebaseUser.getUid(), username + ": " + msg, "New Message", userid, R.mipmap.ic_launcher_round);
